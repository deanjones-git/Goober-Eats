...
public:
	...
	char type() const { return "XPTD"[m_type]; }
	std::string name() const { return m_streetName; }
	std::string dir() const { return m_direction; }
	std::string item() const { return m_item; }
	double dist() const { return m_distance; }
